...
public class AmmoPickup : MonoBehaviour
{
    ...
    public int minAmmo = 1;  // CHANGED: Was 5. Now just 1 bullet.
    public int maxAmmo = 3;  // CHANGED: Was 10. Now max 3 bullets.
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            {
                if (playerShooting.GetCurrentAmmo() >= playerShooting.GetMaxAmmo()) return;
